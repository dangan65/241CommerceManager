 ...
 * - ADD: Records product that was added (to remove on undo)
 * - UPDATE: Records both previous and new state (to restore on undo)
 * - DELETE: Records deleted product (to re-add on undo)
 * 
 */
